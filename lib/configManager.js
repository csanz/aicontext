...
/**
 * In-memory configuration manager (maxFiles, maxDepth, timeout, etc.).
 * Loads/saves from .aicontext/config/config.json in cwd.
 */
class ConfigManager {
  constructor() {
    this.config = {
  ...
  /** Merge newConfig into config and save to disk. */
