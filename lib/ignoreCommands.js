...
function showAddHelp() {
    ...
    console.log(chalk.dim('Examples:'));
    console.log('  cx ignore "*.log"             Exclude all .log files');
    console.log('  cx ignore "build/**"          Exclude build/ recursively');
    console.log('  cx ignore "**/*.test.js"      Exclude test files anywhere');
    console.log('  cx ignore "*.{jpg,png,gif}"   Exclude multiple extensions\n');
