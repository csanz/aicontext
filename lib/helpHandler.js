...
import { addExclusion, showExclusions, clearExclusions, testExclusions } from './configHandler.js';
...
const IGNORE_OPTIONS = {
  ...
  '-i add <pattern>': 'Add new ignore pattern (use quotes: "*.log")',
...
const EXAMPLES = {
  ...
  '$ cx ignore add "*.log"': 'Add ignore pattern (with quotes)',
...
${chalk.dim('Commands:')}
  ...
  cx ignore <command>             Manage ignore patterns
    add <pattern>                 Add new ignore pattern
    show                         Show current patterns
    clear                        Remove all patterns
    test                         Test patterns against directory
    ...
    .command({
      ...
      builder: (yargs) => {
        return yargs
          ...
          .example('cx ignore add "*.log"', 'Add a new ignore pattern')
          .example('cx ignore show', 'Show all ignore patterns')
          .example('cx ignore clear', 'Remove all patterns')
          .example('cx ignore test', 'Test current patterns');
      },
      handler: (argv) => {
