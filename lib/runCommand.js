...
/**
 * Execute context generation or tree with saved paths/options (used by run and run &lt;index&gt;).
 * @param {string[]} paths - Input paths
 * @param {Object} options - Saved options (snapshot, message, verbose, tree, etc.)
 */
